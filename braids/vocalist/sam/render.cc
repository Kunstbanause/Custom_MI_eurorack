...
*/
  ...
  const unsigned char mouthFormants5_29[30] = {
    0, 0, 0, 0, 0, 10,
    14, 19, 24, 27, 23, 21, 16, 20, 14, 18, 14, 18, 18,
    16, 13, 15, 11, 18, 14, 11, 9, 6, 6, 6};

    // throat formants (F2) 5..29
    const unsigned char throatFormants5_29[30] = {
      255, 255,
    ...
    const unsigned char mouthFormants48_53[6] = {19, 27, 21, 27, 18, 13};

    // formant 2 frequencies (throat) 48..53
    const unsigned char throatFormants48_53[6] = {72, 39, 31, 43, 30, 34};
